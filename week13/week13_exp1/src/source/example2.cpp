...
void display()
{
	...
	glUniform3f(materialAmbientLoc, 0.30f, 0.25f, 0.25f);

	unsigned int materialDiffuseLoc = glGetUniformLocation(lightingShader, "material.diffuse");
	glUniform3f(materialDiffuseLoc, 1.0f, 0.85f, 0.55f);

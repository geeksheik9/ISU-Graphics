...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/3.1.materials.vert", "../../src/shader/3.1.materials.frag");
	lampShader = loadShader("../../src/shader/3.1.lamp.vert", "../../src/shader/3.1.lamp.frag");
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Materials and Lighting: Example 1", NULL, NULL);
	if (window == NULL)
	{

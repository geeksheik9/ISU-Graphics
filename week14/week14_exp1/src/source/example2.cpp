...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/5.2.light_casters.vert", "../../src/shader/5.2.light_casters.frag");
	lampShader = loadShader("../../src/shader/5.2.lamp.vert", "../../src/shader/5.2.lamp.frag");
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Light Casters: Example 2", NULL, NULL);
	if (window == NULL)
	{

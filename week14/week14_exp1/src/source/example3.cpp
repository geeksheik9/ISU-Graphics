...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/5.3.light_casters.vert", "../../src/shader/5.3.light_casters.frag");
	lampShader = loadShader("../../src/shader/5.3.lamp.vert", "../../src/shader/5.3.lamp.frag");

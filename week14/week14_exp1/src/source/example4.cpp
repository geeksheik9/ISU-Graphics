...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/5.4.light_casters.vert", "../../src/shader/5.4.light_casters.frag");
	lampShader = loadShader("../../src/shader/5.4.lamp.vert", "../../src/shader/5.4.lamp.frag");
...
void display()
{
	...
	unsigned int outerCutOffLoc = glGetUniformLocation(lightingShader, "light.cutOff");
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Light Casters: Example 3", NULL, NULL);
	if (window == NULL)
	{

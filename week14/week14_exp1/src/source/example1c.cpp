...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/lighting_maps1c.vert", "../../src/shader/lighting_maps1c.frag");
	lampShader = loadShader("../../src/shader/lamp1c.vert", "../../src/shader/lamp1c.frag");

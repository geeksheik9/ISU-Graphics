...
void display()
{
	...
	transform = glm::rotate(transform, (float)glfwGetTime() * 55.5f, glm::vec3(1.0f, 1.0f, 1.0f));
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Flippy Grick", NULL, NULL);
	if (window == NULL)
	{
		std::cout << "Failed to create flippy grick window" << std::endl;
		glfwTerminate();
		return -1;
	}

...
void init(void)
{
	...
	shaderProgram = loadShader("../../src/shader/vshader_week06_lec1a2.glsl", "../../src/shader/fshader_week06_lec1a2.glsl");
...
void display()
{
	...
	int rOffsetLocation = glGetUniformLocation(shaderProgram, "rOffset");

...
int shaderProgram;
int nChangeDirection;

void init(void)
{
	//Return shaderProgram, which is used to set programID
	shaderProgram = loadShader("../../src/shader/vshader_week06_lec1b.glsl", "../../src/shader/fshader_week06_lec1b.glsl");
...
void display()
{
	...
	int nDirectionLoc = glGetUniformLocation(shaderProgram, "nDir");
	glUniform1i(nDirectionLoc, nChangeDirection);

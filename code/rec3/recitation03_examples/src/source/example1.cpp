...
void init(void)
{
	...
	unsigned char *data = stbi_load("../../src/resources/textures/wall2.png", &width, &height, &nrChannels, 0);
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	//load image, create texture and generate mipmaps
	data = stbi_load("../../src/resources/textures/opengl1.png", &width, &height, &nrChannels, 0);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Recitation 03, Q2: Ben Abrams", NULL, NULL);
	if (window == NULL)
	{

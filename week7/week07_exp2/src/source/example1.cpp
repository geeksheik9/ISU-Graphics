...
void init(void)
{
	...
	shaderProgram = loadShader("../../src/shader/texture1.vert", "../../src/shader/texture1b.frag");
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Draw A Triangle with Mixed Texture", NULL, NULL);
	if (window == NULL)
	{

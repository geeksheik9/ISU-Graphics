...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/2.2.3.basic_lighting.vert", "../../src/shader/2.2.3.basic_lighting.frag");
	lampShader = loadShader("../../src/shader/2.2.3.lamp.vert", "../../src/shader/2.2.3.lamp.frag");
...
void display()
{
	...
	glUniform3f(objectColorLoc, 1.0f, 0.0f, 0.8f);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Basic Lighting: Example 1", NULL, NULL);
	if (window == NULL)
	{

...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/2.2.1.basic_lighting.vert", "../../src/shader/2.2.1.basic_lighting.frag");
	lampShader = loadShader("../../src/shader/2.2.1.lamp.vert", "../../src/shader/2.2.1.lamp.frag");

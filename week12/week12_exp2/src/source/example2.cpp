...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/2.2.2.basic_lighting.vert", "../../src/shader/2.2.2.basic_lighting.frag");
	lampShader = loadShader("../../src/shader/2.2.2.lamp.vert", "../../src/shader/2.2.2.lamp.frag");

...
void init(void)
{
	...
	lightingShader = loadShader("../../src/shader/1.colors.vert", "../../src/shader/1.colors.frag");
	lampShader = loadShader("../../src/shader/1.lamp.vert", "../../src/shader/1.lamp.frag");
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Lighting Demo 1", NULL, NULL);
	if (window == NULL)
	{
